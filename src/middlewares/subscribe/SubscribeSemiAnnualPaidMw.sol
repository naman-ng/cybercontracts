...
contract SubscribePaidMw is ISubscribeMiddleware, FeeMw {
    ...
    uint24 internal immutable TIME_PERIOD = 180 days;
     ...
     * @param subscriber Address of subscriber whose subscription validity is to be checked
     * @return boolean The subscription is valid or not.
     */
    function checkSubscriptionValidity(uint256 profileId, address subscriber)
        internal
        view
        returns (bool)
    {
        ...
        address essenceOwnerSubscribeNFTBalance = IProfileNFT(msg.sender)
